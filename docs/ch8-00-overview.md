...
* Move fluently between **geometric diagrams, vector equations, and coordinates**
* Use vectors to **model and solve spatial problems**
* Apply vector methods to **prove geometric results**
* Compute distances, midpoints, angles, and ratios in **three dimensions**
* Use the scalar product to analyse **directional relationships**
